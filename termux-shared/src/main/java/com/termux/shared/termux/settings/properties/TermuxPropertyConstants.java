...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME',{key: 'UP', swipeUp: {macro: 'UP ENTER'}},'END','PGUP'], ['TAB',{key: 'CTRL', swipeDown: {macro: 'CTRL C'}},'ALT','LEFT','DOWN','RIGHT','PGDN']]";
