...
public final class TermuxConstants {
    ...
    public static final String TERMUX_BOOTSTRAP_TARGET_PACKAGE_NAME = "com.termux";
    ...
    public static final class TERMUX_APP {
        ...
        public static final class TERMUX_ACTIVITY {
            ...
            public static final String EXTRA_RESET_SESSIONS = TERMUX_APP.TERMUX_ACTIVITY_NAME + ".EXTRA_RESET_SESSIONS";
        ...
        public static final class TERMUX_SERVICE {
             ...
             */
            public static final String ACTION_REFRESH_NOTIFICATION = TERMUX_PACKAGE_NAME + ".service_refresh_notification";
